...
model = LGBMClassifier(boosting_type='gbdt', n_estimators=500)
...
# Make the reshaping
sub_client_id = sub_client_id.values.reshape(-1, 1)
...
submission.to_csv(f'submission_gbm2.csv', index=False)