...
# For Electra, you need to use 'google/electra-small-discriminator' tokenizer and model
data_clas = TextClasDataBunch.from_df(path=Path(''), train_df=df_train,
                                      ...
                                      tokenizer=Tokenizer.from_pretrained('google/electra-small-discriminator'),
