...
# Model training (Example with Deep Learning)
model = Sequential()
...
print("Root Mean Squared Error (Deep Learning):", rmse)
...
submission = pd.DataFrame({
    ...
    'target': test_predictions.flatten()  # Flattening the predictions to make it a 1D array
})
